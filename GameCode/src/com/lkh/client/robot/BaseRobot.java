package com.lkh.client.robot;

import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

import com.lkh.client.BaseAction;
import com.lkh.client.BaseClient;
import com.lkh.client.ClientData;
...
public abstract class BaseRobot {
	...
	public void conn(){
		try {
			...
			LoggerManager.info("玩家[{}]已经连接到服务器.",userId);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
...
//		LoggerManager.info("执行[{}]类型行为,协议号[{}].参数[{}]"
